...
function Pagination({page, totalResults, goToPage}) {
    const maxPage = Math.ceil(totalResults * 0.1);
    return (
        ...
        <div className="flex flex-1 justify-between sm:hidden max-w-md ml-auto mr-auto">
            ...
            {page < Math.ceil(totalResults * 0.1) ? (
                <a 
                    href="#" 
        ...
        <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
            ...
            <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                ...
                { maxPage <= 7 ? (
                    Array.from({ maxPage }, (_, index) => (
                        <PageLink key={index + 1} curPage={page} goToPage={goToPage} page={index + 1} />
                      ))
                ) : (
                    <>
